export function Cards({imageo,head}) {
  return (
    <div  className="bg-slate-100 rounded-xl shadow-md hover:shadow-xl transition-transform transform hover:scale-105 p-6 space-y-4 border border-blue-100">
      ...
      <img src={imageo} alt="Planted Trees" className="w-full h-[600px] rounded-lg object-cover shadow-md"/>
